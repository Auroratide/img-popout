...
export default class ImgPopoutElement extends HTMLElement {
    ...
    disconnectedCallback() {
        ...
        document.body.removeEventListener('keydown', this.trapTabbing)
    }
    ...
    popout() {
        ...
        document.body.addEventListener('keydown', this.trapTabbing)
    ...
    attachListeners() {
        ...
        this.elements.cover.addEventListener('keydown', (e) => {
            if (e.key === 'Enter')
                this.popin()
        })
